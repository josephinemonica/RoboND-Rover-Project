...
def perception_step(Rover):
    ...
    obstacle=np.abs(-obstacle+1)#invert 1 to 0, 0 to 1 (because it is obstacle)
    ...
    Rover.vision_image[:,:,0] = obstacle*255    #multiplied by 255 because the image values are either 0 or 1, so it's hard to see 1
    ...
    rover_centric_pixel_distances, rover_centric_angles = to_polar_coords(navigable_x_rover, navigable_y_rover) # Convert to polar coords
